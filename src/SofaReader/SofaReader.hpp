...
template <typename T> class SofaReader {
private:
  double sampleRate;
...
public:
  ...
  Eigen::MatrixXd getPositionGrid() { return positionGrid; }

  static std::size_t array3DIndex(const unsigned long i, const unsigned long j,
  ...
  static std::size_t array2DIndex(const unsigned long i, const unsigned long j,
                                  const unsigned long dim1,
